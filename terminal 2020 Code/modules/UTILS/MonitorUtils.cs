...
namespace sorec_gamma.modules.UTILS
{
    public static class MonitorUtils
    {
        ...
        public static string ScreenFriendlyName(this MonitorInfo screen)
        {
            var allFriendlyNames = GetAllMonitorsFriendlyNames();
            List<MonitorInfo> ActualScreens = GetActualScreens();

            for (var index = 0; index < ActualScreens.Count; index++)
                if (Equals(screen, ActualScreens[index]))
                    return allFriendlyNames.ToArray()[index];
            return null;
        }
        ...
        public class MonitorInfo
        {
            ...
            {
                MonitorInfo obj1 = obj as MonitorInfo;
                return obj1 != null
                    && IsPrimary == obj1.IsPrimary
                    && Name == obj1.Name
                    && Bounds == obj1.Bounds;
            }
        ...
        public static List<MonitorInfo> GetActualScreens()
        {
            List<MonitorInfo> ActualScreens = new List<MonitorInfo>();
        ...
        public static System.Drawing.SizeF CurrentAutoScaleDimensions { get; }
    }
}
