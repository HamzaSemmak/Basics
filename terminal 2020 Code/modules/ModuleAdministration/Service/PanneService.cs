...
namespace sorec_gamma.modules.ModuleAdministration.Service
{
    class PanneService
    {
        // private static string _pannePath = "terminal/ReceptionPannes";
        private static object _lock = new object();
        private static readonly ILog Logger = LogManager.GetLogger(typeof(PanneService));
        ...
        public static string SendRequest(string data, string mac)
        {
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    {
                        string uri = ConfigUtils.ConfigData.GetAddress() + "/sorecws/api/terminal/ReceptionPannes";
