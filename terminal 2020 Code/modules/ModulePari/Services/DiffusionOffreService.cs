...
{
    class DiffusionOffreService
    {
        // private static string _path = "terminal/DiffusionOffre";

        private static object _lock = new object();
        private static readonly ILog Logger = LogManager.GetLogger(typeof(DiffusionOffreService));
        ...
        public static string SendRequest(string data, string mac)
        {
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    {
                        string uri = ConfigUtils.ConfigData.GetAddress() + "/sorecws/api/terminal/DiffusionOffre";
