...
namespace sorec_gamma.modules.ModulePari.Services
{
    ...
    {
        // private static string _path = "terminal/DemandeCote";

        private static object _lock = new object();
        private static readonly ILog Logger = LogManager.GetLogger(typeof(CoteService));
        ...
        public static string SendRequest(string data, string mac)
        {
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    {
                        string uri = ConfigUtils.ConfigData.GetAddress() + "/sorecws/api/terminal/DemandeCote";
