...
namespace sorec_gamma.modules.ModuleMAJ.Service
{
    class MAJService
    {
        // private static string _path = "terminal/MAJLogiciel";

        private static object _lock = new object();
        private static readonly ILog Logger = LogManager.GetLogger(typeof(MAJService));
        public static string SendRequest(string data, string mac)
        {
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    {
                        string uri = ConfigUtils.ConfigData.GetAddress() + "/sorecws/api/terminal/MAJLogiciel";
