...
{
    class ButtonZ : System.Windows.Forms.Button  
    {
        ...
        private Color clickcolor1 = Color.Orange;
        ...
        {
            base.OnResize(e);
            textX = (int)((this.Width /10) );
            textY = (int)((this.Height / 5) + 5);
        }
